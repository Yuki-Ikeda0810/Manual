...
1. [**Ubuntuのバージョンをアップデートする方法**](#1-Ubuntuのバージョンをアップデートする方法)
...
2. [**初めてWindowsとUbuntuをデュアルブートするためにUbuntuをインストールする方法**](#2-初めてWindowsとUbuntuをデュアルブートするためにUbuntuをインストールする方法)
...
## **2. 初めてWindowsとUbuntuをデュアルブートするためにUbuntuをインストールする方法**
